...
1. **Automatic** — All project essentials are provisioned with minimal <Term title="development and operations" to="/docs/quickstart/terminology#builds-and-tooling">DevOps</Term> effort. You should not need to wire up basics by hand; the defaults handle it.
...
- **Node.js <Term title="long term support" to="/docs/quickstart/terminology#fundamentals">LTS</Term> first** — Nova tracks the latest long-term support baselines for Node.js.
- **Modern modules** — Nova targets <Term title="ECMAScript Modules" to="/docs/quickstart/terminology#javascript-and-typescript">ESM</Term>-based builds and excludes legacy "script" pipelines.
