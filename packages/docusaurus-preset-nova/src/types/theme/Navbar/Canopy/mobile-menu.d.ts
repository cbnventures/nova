...
export type Theme_Navbar_Canopy_MobileMenu_MobileMenu_Pathname = string;
...
export type Theme_Navbar_Canopy_MobileMenu_MobileMenu_NavItemType = string | undefined;

export type Theme_Navbar_Canopy_MobileMenu_MobileMenu_NavItemChildren = Record<string, unknown>[] | undefined;
...
export type Theme_Navbar_Canopy_MobileMenu_MobileMenu_ChildItem = Record<string, unknown>;

export type Theme_Navbar_Canopy_MobileMenu_MobileMenu_LinkProps = Record<string, string>;

export type Theme_Navbar_Canopy_MobileMenu_MobileMenu_ChildTo = string | undefined;

export type Theme_Navbar_Canopy_MobileMenu_MobileMenu_ChildIsActive = boolean;

export type Theme_Navbar_Canopy_MobileMenu_MobileMenu_ChildKey = string;

export type Theme_Navbar_Canopy_MobileMenu_MobileMenu_LinkSpread = Record<string, string>;

export type Theme_Navbar_Canopy_MobileMenu_MobileMenu_ChildLabel = string;
