...
id: "run-recipes"
title: "Run Recipes"
description: "Run all configured recipes in sequence across both GitHub and package-json categories so every workspace stays consistent with a single command."
keywords:
  - "nova"
  - "nova run-recipes"
  - "package.json"
