...
description: "Configure Docusaurus plugin options passed through the Nova preset with this full reference covering docs, blog, pages, and sitemap."
sidebar_position: 3
keywords:
  - "nova"
  - "docusaurus facades"
...
Some defaults differ from Docusaurus's own defaults, and Nova-specific overrides are noted in the table descriptions. The types in `nova-config.d.ts` are the source of truth.
:::
