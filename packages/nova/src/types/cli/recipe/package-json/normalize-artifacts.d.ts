 ...
 * @since 0.14.0
 */
export type Cli_Recipe_PackageJson_NormalizeArtifacts_Runner_Handle_Workspace = Shared_WorkspaceManifest;
...
export type Cli_Recipe_PackageJson_NormalizeArtifacts_Runner_Handle_Manifest = Shared_NovaConfigWorkspace;
 ...
 * @since 0.14.0
 */
export type Cli_Recipe_PackageJson_NormalizeArtifacts_Runner_HandlePublish_Workspace = Shared_WorkspaceManifest;
...
export type Cli_Recipe_PackageJson_NormalizeArtifacts_Runner_HandlePublish_Manifest = Shared_NovaConfigWorkspace;
...
export type Cli_Recipe_PackageJson_NormalizeArtifacts_Runner_Run_WorkingFile = Shared_NovaConfigConfig;

export type Cli_Recipe_PackageJson_NormalizeArtifacts_Runner_Run_WorkingFileWorkspaces = [string, Shared_NovaConfigWorkspace][];

export type Cli_Recipe_PackageJson_NormalizeArtifacts_Runner_Run_ConfigRecipes = Shared_NovaConfig_Recipes | undefined;

export type Cli_Recipe_PackageJson_NormalizeArtifacts_Runner_Run_ConfigRecipesPackageJson = Shared_NovaConfig_Recipes_PackageJson | undefined;

export type Cli_Recipe_PackageJson_NormalizeArtifacts_Runner_Run_EligibleWorkspaces = [string, Shared_NovaConfigWorkspace][];

export type Cli_Recipe_PackageJson_NormalizeArtifacts_Runner_Run_EligiblePath = string;

export type Cli_Recipe_PackageJson_NormalizeArtifacts_Runner_Run_EligibleWorkspaceRecipes = Shared_NovaConfig_Recipes_PackageJsonWorkspace | undefined;

export type Cli_Recipe_PackageJson_NormalizeArtifacts_Runner_Run_EligibleEntry = Shared_NovaConfig_RecipeEntry | undefined;

export type Cli_Recipe_PackageJson_NormalizeArtifacts_Runner_Run_Workspaces = Shared_WorkspaceManifest[];
