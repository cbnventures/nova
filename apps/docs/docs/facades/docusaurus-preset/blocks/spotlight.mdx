...
id: "spotlight"
title: "Spotlight"
description: "Highlighted section with a heading and freeform children content for showcasing a key feature or code preview on landing pages."
sidebar_position: 4
keywords:
  - "nova"
  - "docusaurus facades"
...
| `className` | `string \| undefined`        | `undefined` | Additional class names merged with the base `nova-spotlight` class. |
