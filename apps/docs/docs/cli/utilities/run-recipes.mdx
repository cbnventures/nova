...
id: "run-recipes"
title: "Run Recipes"
description: "Run all registered recipes in sequence across the GitHub, license, miscellaneous, read-me, and package-json categories with a single command."
keywords:
  - "nova"
  - "nova run-recipes"
  - "package.json"
...
Run all registered <Terminology title="transform script" to="/docs/quickstart/terminology#nova-concepts" color={true}>recipes</Terminology> in sequence.
