...
import type {
  ...
  Rules_Eslint_Safety_NoScriptUrl_Runner_Create_Literal_Node,
  Rules_Eslint_Safety_NoScriptUrl_Runner_Create_Literal_Returns,
  Rules_Eslint_Safety_NoScriptUrl_Runner_Create_Options,
...
export class Runner {
  ...
  public static rule = ESLintUtils.RuleCreator(() => '#')({
    ...
    create(context, defaultOptions) {
      const options: Rules_Eslint_Safety_NoScriptUrl_Runner_Create_Options = defaultOptions[0];
      ...
      return {
        Literal(node: Rules_Eslint_Safety_NoScriptUrl_Runner_Create_Literal_Node): Rules_Eslint_Safety_NoScriptUrl_Runner_Create_Literal_Returns {
