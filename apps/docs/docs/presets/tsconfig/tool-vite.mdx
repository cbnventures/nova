...
Align TypeScript with how <Terminology title="build tool" to="/docs/quickstart/terminology#builds-and-tooling" color={true}>Vite</Terminology> resolves and transpiles your code, so the compiler type-checks while Vite owns the build output.
