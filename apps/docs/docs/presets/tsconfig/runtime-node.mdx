...
id: "runtime-node"
title: "Runtime - Node"
description: "Add Node ESM module resolution and the ESNext lib to a Nova TSConfig chain for server-side code that runs on the Node.js runtime."
keywords:
  - "nova"
  - "runtime-node"
  - "tsconfig preset"
...
3. Uses Node's current module detection so emitted <Terminology title="ECMAScript Modules" to="/docs/quickstart/terminology#javascript-and-typescript" color={true}>ESM</Terminology> and <Terminology title="CJS" to="/docs/quickstart/terminology#javascript-and-typescript" color={true}>CommonJS</Terminology> match how Node treats each file.
