...
Derive from the collection name in singular form. No single-letter abbreviations.
...
One descriptive comment per code block. No consecutive comments without code between them. No `Step 1:`, `Step 2:` prefixes.
