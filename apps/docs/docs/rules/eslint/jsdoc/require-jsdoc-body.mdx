...
description: "Require a body paragraph in JSDoc blocks that explains why the declaration exists rather than restating the function or class name."
keywords:
  - "nova"
  - "eslint rule"
  - "jsdoc"
...
<Tabs groupId="require-jsdoc-body-diamond-examples">
  <TabItem value="correct" label="Correct" default>
     ...
     *
     * Reads the file at
     * the given path and returns a parsed object
     * from its contents.
     *
     * @param {string} path - Path.
     *
