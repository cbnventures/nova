...
import type {
  ...
  Theme_Navbar_Canopy_MobileMenu_MobileMenu_ChildIsActive,
  Theme_Navbar_Canopy_MobileMenu_MobileMenu_ChildItem,
  Theme_Navbar_Canopy_MobileMenu_MobileMenu_ChildKey,
  Theme_Navbar_Canopy_MobileMenu_MobileMenu_ChildLabel,
  Theme_Navbar_Canopy_MobileMenu_MobileMenu_ChildTo,
  ...
  Theme_Navbar_Canopy_MobileMenu_MobileMenu_NavItemChildren,
  Theme_Navbar_Canopy_MobileMenu_MobileMenu_NavItemType,
  ...
  Theme_Navbar_Canopy_MobileMenu_MobileMenu_Pathname,
...
function MobileMenu(props: Theme_Navbar_Canopy_MobileMenu_MobileMenu_Props): Theme_Navbar_Canopy_MobileMenu_MobileMenu_Returns {
  ...
  const pathname: Theme_Navbar_Canopy_MobileMenu_MobileMenu_Pathname = useLocation()['pathname'];
            ...
            <div className="nova-navbar-canopy-menu-items nova-mobile-menu-items">
              {
                items.map((navItem: Theme_Navbar_Index_Navbar_Item, itemIndex: Theme_Navbar_Canopy_MobileMenu_MobileMenu_ItemIndex) => {
                  const navItemType: Theme_Navbar_Canopy_MobileMenu_MobileMenu_NavItemType = navItem['type'] as Theme_Navbar_Canopy_MobileMenu_MobileMenu_NavItemType;
                  const navItemChildren: Theme_Navbar_Canopy_MobileMenu_MobileMenu_NavItemChildren = navItem['items'] as Theme_Navbar_Canopy_MobileMenu_MobileMenu_NavItemChildren;
                  ...
                  if (
                    ...
                    const dropdownIcon: Theme_Navbar_Canopy_MobileMenu_MobileMenu_ItemIcon = navItem['icon'] as Theme_Navbar_Canopy_MobileMenu_MobileMenu_ItemIcon;

                    return (
                      <details key={navItem['label']} className="nova-navbar-canopy-menu-dropdown" style={itemStyle}>
                        <summary className="nova-navbar-canopy-menu-dropdown-summary">
                          <Icon icon={dropdownIcon ?? 'lucide:chevron-down'} width="18" height="18" aria-hidden="true" />
                          <span>{navItem['label']}</span>
                        </summary>
                        <div className="nova-navbar-canopy-menu-dropdown-children">
                          {
                            (navItemChildren ?? []).map((childItem: Theme_Navbar_Canopy_MobileMenu_MobileMenu_ChildItem) => {
                              const childIcon: Theme_Navbar_Canopy_MobileMenu_MobileMenu_ItemIcon = childItem['icon'] as Theme_Navbar_Canopy_MobileMenu_MobileMenu_ItemIcon;
                              const childLinkProps: Theme_Navbar_Canopy_MobileMenu_MobileMenu_LinkProps = {};
                              const childTo: Theme_Navbar_Canopy_MobileMenu_MobileMenu_ChildTo = childItem['to'] as Theme_Navbar_Canopy_MobileMenu_MobileMenu_ChildTo;
                              const childIsActive: Theme_Navbar_Canopy_MobileMenu_MobileMenu_ChildIsActive = (typeof childTo === 'string' && pathname.startsWith(childTo) === true);
                              ...
                              return (
                                <Link
                                  ...
                                  key={childItem['label'] as Theme_Navbar_Canopy_MobileMenu_MobileMenu_ChildKey}
                                  {...(childLinkProps as Theme_Navbar_Canopy_MobileMenu_MobileMenu_LinkSpread)}
                                  onClick={() => {
                                    setIsClosing(true);
                                ...
                                >
                                  ...
                                  <span>{childItem['label'] as Theme_Navbar_Canopy_MobileMenu_MobileMenu_ChildLabel}</span>
                                </Link>
                              );
                            })
                          }
