...
export type Tests_Cli_Scaffold_App_Workers_CliScaffoldAppWorkersRun_AddsWorkspaceAtMonorepoRoot_NovaConfig = string;

export type Tests_Cli_Scaffold_App_Workers_CliScaffoldAppWorkersRun_AddsWorkspaceAtMonorepoRoot_NovaConfigPath = string;
