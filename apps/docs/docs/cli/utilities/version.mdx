...
- **<Term title="continuous integration and deployment" to="/docs/quickstart/terminology#builds-and-tooling">CI/CD</Term> pipelines** — Record system information in build logs or artifacts for reproducibility.
