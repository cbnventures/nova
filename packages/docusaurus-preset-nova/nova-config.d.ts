...
export type NovaPresetName = 'envoy' | 'foundry' | 'lantern' | 'marshal' | 'sentinel' | 'signal';
...
// Light mode logo - URL path from static dir (e.g., "/images/logo.svg"). Defaults to "".
export type NovaThemeConfigSiteLogoSrcLight = string | undefined;
...
export type NovaThemeConfigSiteLogoSrc = {
  light?: NovaThemeConfigSiteLogoSrcLight;
  dark?: NovaThemeConfigSiteLogoSrcDark;
} | undefined;

// Clicking the logo navigates to this URL (e.g., "https://example.com").
export type NovaThemeConfigSiteLogoHref = string | undefined;

// Link target attribute (e.g., "_blank" for opening in a new tab).
export type NovaThemeConfigSiteLogoTarget = string | undefined;

// Link rel attribute (e.g., "noopener noreferrer").
export type NovaThemeConfigSiteLogoRel = string | undefined;

// Accessible label for the logo link (e.g., "Home").
export type NovaThemeConfigSiteLogoAriaLabel = string | undefined;

// Light mode wordmark - URL path from static dir (e.g., "/images/wordmark.svg").
export type NovaThemeConfigSiteLogoWordmarkLight = string | undefined;
...
// Wordmark image - light/dark variants.
export type NovaThemeConfigSiteLogoWordmark = {
  light?: NovaThemeConfigSiteLogoWordmarkLight;
...
export type NovaThemeConfigSiteLogo = {
  ...
  target?: NovaThemeConfigSiteLogoTarget;
...
// Iconify icon ID or object (e.g., "lucide:book-open", "ri:github-fill").
...
// Navbar configuration - items and scroll behavior.
...
// Single share platform - social network or copy-link affordance for blog posts.
export type NovaThemeConfigBlogSharePlatform = 'x' | 'facebook' | 'linkedin' | 'reddit' | 'copy';

// Share button platforms shown on blog posts. Defaults to [].
export type NovaThemeConfigBlogSharePlatforms = NovaThemeConfigBlogSharePlatform[] | undefined;

// Blog post share configuration.
export type NovaThemeConfigBlogShare = {
  platforms?: NovaThemeConfigBlogSharePlatforms;
  [key: string]: unknown;
} | undefined;

// Blog theme configuration - sidebar, layout, and share.
export type NovaThemeConfigBlog = {
  sidebar?: NovaThemeConfigBlogSidebar;
  layout?: NovaThemeConfigBlogLayout;
  share?: NovaThemeConfigBlogShare;
  [key: string]: unknown;
} | undefined;
...
// 404 page heading - replaces Nova's randomized title pool when set.
export type NovaThemeConfigErrorPagesNotFoundTitle = string | undefined;

// 404 page description - replaces Nova's randomized description pool when set.
export type NovaThemeConfigErrorPagesNotFoundDescription = string | undefined;

// "Back to home" CTA label on the 404 page (e.g., "Back to home", "Return to start").
export type NovaThemeConfigErrorPagesNotFoundBackHomeLabel = string | undefined;

// "Back to home" CTA href on the 404 page. Defaults to the site `baseUrl`.
export type NovaThemeConfigErrorPagesNotFoundBackHomeHref = string | undefined;

// 404 page content overrides.
export type NovaThemeConfigErrorPagesNotFound = {
  title?: NovaThemeConfigErrorPagesNotFoundTitle;
  description?: NovaThemeConfigErrorPagesNotFoundDescription;
  backHomeLabel?: NovaThemeConfigErrorPagesNotFoundBackHomeLabel;
  backHomeHref?: NovaThemeConfigErrorPagesNotFoundBackHomeHref;
} | undefined;

// Per-page crash heading - replaces Nova's randomized title pool when set.
export type NovaThemeConfigErrorPagesErrorPageContentTitle = string | undefined;

// Retry button label on the per-page crash fallback (e.g., "Try again", "Reload").
export type NovaThemeConfigErrorPagesErrorPageContentRetryLabel = string | undefined;

// Per-page crash content overrides.
export type NovaThemeConfigErrorPagesErrorPageContent = {
  title?: NovaThemeConfigErrorPagesErrorPageContentTitle;
  retryLabel?: NovaThemeConfigErrorPagesErrorPageContentRetryLabel;
} | undefined;

// Retry button label on the top-level error boundary fallback.
export type NovaThemeConfigErrorPagesErrorRetryLabel = string | undefined;

// Top-level error boundary content overrides.
export type NovaThemeConfigErrorPagesError = {
  retryLabel?: NovaThemeConfigErrorPagesErrorRetryLabel;
} | undefined;

// Error pages configuration - overrides Nova's defaults for 404 / per-page crash / top-level error surfaces.
export type NovaThemeConfigErrorPages = {
  notFound?: NovaThemeConfigErrorPagesNotFound;
  errorPageContent?: NovaThemeConfigErrorPagesErrorPageContent;
  error?: NovaThemeConfigErrorPagesError;
} | undefined;
...
// Iconify icon ID or object (e.g., "ri:github-fill", "ri:twitter-x-fill").
...
export type NovaThemeConfig = {
  ...
  errorPages?: NovaThemeConfigErrorPages;
...
// Display label for the locale dropdown (e.g., "English", "Francais").
