...
export type Lib_Toc_FilterToc_Results = Array<Shared_TocHeading>;

export type Lib_Toc_FilterToc_FilteredChildren = Array<Shared_TocHeading>;

export type Lib_Toc_FilterToc_IsInRange = boolean;

export type Lib_Toc_FilterToc_KeptItem = Pick<Shared_TocHeading, 'value' | 'id' | 'level' | 'children'>;
 ...
 * @since 0.15.0
 */
export type Lib_Toc_TreeifyToc_Item_Children_Children_Children_Children_Children_Value = Shared_TocHeading_Value;

export type Lib_Toc_TreeifyToc_Item_Children_Children_Children_Children_Children_Id = Shared_TocHeading_Id;

export type Lib_Toc_TreeifyToc_Item_Children_Children_Children_Children_Children_Level = Shared_TocHeading_Level;

export type Lib_Toc_TreeifyToc_Item_Children_Children_Children_Children_Children = {
  value: Lib_Toc_TreeifyToc_Item_Children_Children_Children_Children_Children_Value;
  id: Lib_Toc_TreeifyToc_Item_Children_Children_Children_Children_Children_Id;
  level: Lib_Toc_TreeifyToc_Item_Children_Children_Children_Children_Children_Level;
...
export type Lib_Toc_TreeifyToc_Headings = Array<Shared_TocHeading>;
...
export type Lib_Toc_TreeifyToc_Roots = Array<Shared_TocHeading>;

export type Lib_Toc_TreeifyToc_ParentIndex = number;

export type Lib_Toc_TreeifyToc_Parent = Pick<Shared_TocHeading, 'value' | 'id' | 'level' | 'children'>;
