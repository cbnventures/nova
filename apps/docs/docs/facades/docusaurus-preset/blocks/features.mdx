...
id: "features"
title: "Features"
description: "Lay out feature cards in a responsive grid with optional Iconify icons, titles, and descriptions using per-preset styling and columns."
sidebar_position: 2
keywords:
  - "nova"
  - "docusaurus facades"
...
The Features block renders a `<section>` containing a grid of cards. Each card can include an Iconify icon, a title, and a description.

The grid adapts from one column on mobile to three columns on desktop.
...
import { Features } from '@cbnventures/docusaurus-preset-nova/blocks';
...
| `className` | `string \| undefined`                                                                      | `undefined` | Additional class names merged with the base `nova-features` class. |
