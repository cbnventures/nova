...
<details>
  ...
  <ul>
    <li><strong>What</strong>: Keep them in sync by using <code>{'"module": "nodenext"'}</code> with <code>{'"moduleResolution": "nodenext"'}</code> for Node ESM, or <code>{'"module": "esnext"'}</code> with <code>{'"moduleResolution": "bundler"'}</code> for bundlers.</li>
