...
id: terminology
title: Terminology
description: Nova concepts, workspace policies, and plain language developer terminology with clear definitions for APIs, packages, JavaScript modules, build tools, Git workflow, testing, performance, and security.
keywords:
  - nova
  - nova concepts
  - workspace policy
