...
import type {
  ...
  Rules_Eslint_Formatting_NoTernaryInTemplateLiteral_Runner_Create_Options,
  Rules_Eslint_Formatting_NoTernaryInTemplateLiteral_Runner_Create_TemplateLiteral_Node,
  Rules_Eslint_Formatting_NoTernaryInTemplateLiteral_Runner_Create_TemplateLiteral_Returns,
...
export class Runner {
  ...
  public static rule = ESLintUtils.RuleCreator(() => '#')({
    ...
    create(context, defaultOptions) {
      const options: Rules_Eslint_Formatting_NoTernaryInTemplateLiteral_Runner_Create_Options = defaultOptions[0];
      ...
      return {
        TemplateLiteral(node: Rules_Eslint_Formatting_NoTernaryInTemplateLiteral_Runner_Create_TemplateLiteral_Node): Rules_Eslint_Formatting_NoTernaryInTemplateLiteral_Runner_Create_TemplateLiteral_Returns {
