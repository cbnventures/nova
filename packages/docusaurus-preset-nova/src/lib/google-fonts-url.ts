...
import type {
  Lib_GoogleFontsUrl_BaseUrl,
  Lib_GoogleFontsUrl_BuildGoogleFontsUrl_BuildFamilyPart,
  Lib_GoogleFontsUrl_BuildGoogleFontsUrl_BuildFamilyPart_EncodedName,
  Lib_GoogleFontsUrl_BuildGoogleFontsUrl_BuildFamilyPart_Returns,
...
export function buildGoogleFontsUrl(families: Lib_GoogleFontsUrl_BuildGoogleFontsUrl_Families, display: Lib_GoogleFontsUrl_BuildGoogleFontsUrl_Display): Lib_GoogleFontsUrl_BuildGoogleFontsUrl_Returns {
  ...
  const familyParts: Lib_GoogleFontsUrl_BuildGoogleFontsUrl_FamilyParts = families.map(buildFamilyPart);
  ...
  return `${baseUrl}?${query}&${displayPart}`;
}
