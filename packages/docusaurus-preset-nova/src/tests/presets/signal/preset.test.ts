...
import type {
  Tests_Presets_Signal_Preset_PresetsSignalPresetSignal_HasCorrectColorValues_Signal,
  Tests_Presets_Signal_Preset_PresetsSignalPresetSignal_HasCorrectDepthValues_Signal,
  Tests_Presets_Signal_Preset_PresetsSignalPresetSignal_HasCorrectFontNames_Signal,
  Tests_Presets_Signal_Preset_PresetsSignalPresetSignal_HasCorrectMotionValues_Signal,
  Tests_Presets_Signal_Preset_PresetsSignalPresetSignal_HasCorrectShapeValues_Signal,
  Tests_Presets_Signal_Preset_PresetsSignalPresetSignalNavbarAndFooter_HasCorrectFooterValue_Footer,
  Tests_Presets_Signal_Preset_PresetsSignalPresetSignalNavbarAndFooter_HasCorrectNavbarValue_Navbar,
...
describe('presetsSignalPresetSignal', async () => {
  ...
  it('has correct font names', () => {
    const signal: Tests_Presets_Signal_Preset_PresetsSignalPresetSignal_HasCorrectFontNames_Signal = presetsSignalPresetSignal;
  ...
  it('has correct shape values', () => {
    const signal: Tests_Presets_Signal_Preset_PresetsSignalPresetSignal_HasCorrectShapeValues_Signal = presetsSignalPresetSignal;
  ...
  it('has correct depth values', () => {
    const signal: Tests_Presets_Signal_Preset_PresetsSignalPresetSignal_HasCorrectDepthValues_Signal = presetsSignalPresetSignal;
  ...
  it('has correct motion values', () => {
    const signal: Tests_Presets_Signal_Preset_PresetsSignalPresetSignal_HasCorrectMotionValues_Signal = presetsSignalPresetSignal;
...
describe('presetsSignalPresetSignal navbar and footer', async () => {
  it('has correct navbar value', () => {
    const navbar: Tests_Presets_Signal_Preset_PresetsSignalPresetSignalNavbarAndFooter_HasCorrectNavbarValue_Navbar = presetsSignalPresetSignal['navbar'];
  ...
  it('has correct footer value', () => {
    const footer: Tests_Presets_Signal_Preset_PresetsSignalPresetSignalNavbarAndFooter_HasCorrectFooterValue_Footer = presetsSignalPresetSignal['footer'];
