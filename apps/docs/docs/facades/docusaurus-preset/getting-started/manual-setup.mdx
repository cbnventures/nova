...
id: "manual-setup"
title: "Manual Setup"
description: "Install and configure the Nova Docusaurus preset in an existing Docusaurus v3 project with preset options and theme config."
sidebar_position: 2
keywords:
  - "nova"
  - "docusaurus facades"
...
:::info ECMAScript module package
