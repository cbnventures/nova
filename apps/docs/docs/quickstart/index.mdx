...
- **Node.js [LTS](/docs/quickstart/terminology#fundamentals) first** — Nova tracks the latest long-term support baselines for Node.js.
- **Modern modules** — Nova targets [ESM](/docs/quickstart/terminology#javascript-and-typescript)-based builds and excludes legacy "script" pipelines.
