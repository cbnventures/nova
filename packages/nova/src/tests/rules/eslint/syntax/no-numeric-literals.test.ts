...
import type { Tests_Rules_Eslint_Syntax_NoNumericLiterals_RuleTester } from '../../../../types/tests/rules/eslint/syntax/no-numeric-literals.test.d.ts';
...
const ruleTester: Tests_Rules_Eslint_Syntax_NoNumericLiterals_RuleTester = new RuleTester({
  languageOptions: {
    ecmaVersion: 2022,
    sourceType: 'module',
  },
