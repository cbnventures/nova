...
id: "search"
title: "Search"
description: "Search your documentation with built-in Lunr-powered full-text matching, fuzzy results, multi-language support, and non-blocking web worker queries."
sidebar_position: 4
keywords:
  - "nova"
  - "docusaurus facades"
...
2. **Query execution** — the search engine runs exact, wildcard, and fuzzy match strategies against the index and merges the results.
