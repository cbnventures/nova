...
id: "terminology"
title: "Terminology"
description: "Expand abbreviations on hover with an inline glossary block that optionally links to a glossary page using per-preset tooltip styling."
sidebar_position: 9
keywords:
  - "nova"
  - "docusaurus facades"
...
Inline glossary block that expands abbreviations on hover. Wrap any text to add a tooltip with the expanded form.

Optionally links to a glossary page and supports a color accent.
