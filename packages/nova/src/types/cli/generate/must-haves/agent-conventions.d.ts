...
export type Cli_Generate_MustHaves_AgentConventions_Runner_Run_Returns = Promise<Shared_GeneratorRunResult>;
...
export type Cli_Generate_MustHaves_AgentConventions_Runner_Run_WorkingFile = Shared_NovaConfig;
