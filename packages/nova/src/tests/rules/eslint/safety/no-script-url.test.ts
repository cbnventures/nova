...
import type { Tests_Rules_Eslint_Safety_NoScriptUrl_RuleTester } from '../../../../types/tests/rules/eslint/safety/no-script-url.test.d.ts';
...
const ruleTester: Tests_Rules_Eslint_Safety_NoScriptUrl_RuleTester = new RuleTester({
  languageOptions: {
    ecmaVersion: 2022,
    sourceType: 'module',
  },
