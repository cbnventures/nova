...
2. Sets `moduleResolution` to `Bundler` so imports resolve the way a <Terminology title="build tool" to="/docs/quickstart/terminology#builds-and-tooling" color={true}>bundler</Terminology> resolves them rather than the way Node does.
