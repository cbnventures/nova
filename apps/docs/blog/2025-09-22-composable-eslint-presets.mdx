...
description: "Nova ESLint presets use independent layers — language, environment, and framework — to replace brittle config inheritance with predictable composition."
