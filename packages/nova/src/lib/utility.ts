 ...
 * @since 0.11.0
 */
export async function saveGeneratedFile(targetPath: LibUtilitySaveGeneratedFileTargetPath, contents: LibUtilitySaveGeneratedFileContents, replaceFile: LibUtilitySaveGeneratedFileReplaceFile): LibUtilitySaveGeneratedFileReturns {
  ...
  if (await pathExists(targetPath) === true) {
    if (await isFileIdentical(targetPath, contents) === true) {
      Logger.customize({
