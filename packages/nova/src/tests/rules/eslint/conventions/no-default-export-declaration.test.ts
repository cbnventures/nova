...
import type { Tests_Rules_Eslint_Conventions_NoDefaultExportDeclaration_RuleTester } from '../../../../types/tests/rules/eslint/conventions/no-default-export-declaration.test.d.ts';
...
const ruleTester: Tests_Rules_Eslint_Conventions_NoDefaultExportDeclaration_RuleTester = new RuleTester({
  languageOptions: {
    ecmaVersion: 2022,
    sourceType: 'module',
    parser: tsParser,
