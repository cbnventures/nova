...
description: "Require parenthesized condition in ternary expressions so the test clause is visually separated from the consequent and alternate branches."
keywords:
  - "nova"
  - "eslint rule"
  - "ternary"
