...
| `suffix`     | `string`   | Required label appended to the output filename and workflow name. Must be unique within the same template.     |
...
| Field        | Type       | Description                                                                                                                                                                                 |
|--------------|------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `type`       | `string`   | One of: `"npm"`, `"github-action"`, `"github-packages"`, `"docker-hub"`, `"ghcr"`, `"cloudflare-pages-docusaurus"`, `"github-pages-docusaurus"`, `"aws-amplify-nextjs"`, `"vercel-nextjs"`. |
