...
Identifies the GitHub repository and configures repository-level metadata that the GitHub recipes synchronize. Consumed by [`nova generate github`](/docs/cli/generators/github) commands.
