...
/**
 * Rules - ESLint - Syntax - No Destructuring - Create.
 *
 * @since 0.14.0
 */
export type Rules_Eslint_Syntax_NoDestructuring_Runner_Create_Options_AssignmentExpressions = boolean;

export type Rules_Eslint_Syntax_NoDestructuring_Runner_Create_Options_CallbackParams = boolean;

export type Rules_Eslint_Syntax_NoDestructuring_Runner_Create_Options_ForOfLoops = boolean;

export type Rules_Eslint_Syntax_NoDestructuring_Runner_Create_Options_FunctionParams = boolean;

export type Rules_Eslint_Syntax_NoDestructuring_Runner_Create_Options_IgnoreFiles = string[];

export type Rules_Eslint_Syntax_NoDestructuring_Runner_Create_Options_VariableDeclarations = boolean;

export type Rules_Eslint_Syntax_NoDestructuring_Runner_Create_Options = Readonly<{
  assignmentExpressions: Rules_Eslint_Syntax_NoDestructuring_Runner_Create_Options_AssignmentExpressions;
  callbackParams: Rules_Eslint_Syntax_NoDestructuring_Runner_Create_Options_CallbackParams;
  forOfLoops: Rules_Eslint_Syntax_NoDestructuring_Runner_Create_Options_ForOfLoops;
  functionParams: Rules_Eslint_Syntax_NoDestructuring_Runner_Create_Options_FunctionParams;
  ignoreFiles: Rules_Eslint_Syntax_NoDestructuring_Runner_Create_Options_IgnoreFiles;
  variableDeclarations: Rules_Eslint_Syntax_NoDestructuring_Runner_Create_Options_VariableDeclarations;
}>;

export type Rules_Eslint_Syntax_NoDestructuring_Runner_Create_CheckCallbackParams = boolean;

export type Rules_Eslint_Syntax_NoDestructuring_Runner_Create_CheckFunctionParams = boolean;

export type Rules_Eslint_Syntax_NoDestructuring_Runner_Create_CheckForOfLoops = boolean;

export type Rules_Eslint_Syntax_NoDestructuring_Runner_Create_CheckVariableDeclarations = boolean;

export type Rules_Eslint_Syntax_NoDestructuring_Runner_Create_CheckAssignmentExpressions = boolean;

export type Rules_Eslint_Syntax_NoDestructuring_Runner_Create_InsideCallback_Value = boolean;

export type Rules_Eslint_Syntax_NoDestructuring_Runner_Create_InsideCallback = {
  value: Rules_Eslint_Syntax_NoDestructuring_Runner_Create_InsideCallback_Value;
};
