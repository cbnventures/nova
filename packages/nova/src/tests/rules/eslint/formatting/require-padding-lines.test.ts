...
import type { Tests_Rules_Eslint_Formatting_RequirePaddingLines_RuleTester } from '../../../../types/tests/rules/eslint/formatting/require-padding-lines.test.d.ts';
...
const ruleTester: Tests_Rules_Eslint_Formatting_RequirePaddingLines_RuleTester = new RuleTester({
  languageOptions: {
    ecmaVersion: 2022,
    sourceType: 'module',
  },
