...
import type { Tests_Rules_Eslint_Conventions_RequireExplicitReturn_RuleTester } from '../../../../types/tests/rules/eslint/conventions/require-explicit-return.test.d.ts';
...
const ruleTester: Tests_Rules_Eslint_Conventions_RequireExplicitReturn_RuleTester = new RuleTester({
  languageOptions: {
    ecmaVersion: 2022,
    sourceType: 'module',
  },
